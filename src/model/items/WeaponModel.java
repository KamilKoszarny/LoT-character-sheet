...
public enum WeaponModel implements ItemModel {
    ...
    FEATHERY_WAND(WeaponType.MAGES,      3, 3, 1, 15,       false, 0, 1, 6, "Pierzasta różdżka", new Modifier(ModifierType.MP_MAX, 5), new Modifier(ModifierType.MP_INCREASE, 1)),
    BONE_WAND(WeaponType.MAGES,          3, 3, 1, 15,       false, 0, 2, 6, "Kościana różdżka", new Modifier(ModifierType.MP_MAX, 10)),
    ...
    COLD_SPHERE(WeaponType.MAGES,        3, 3, 1, 10,       false, 15, 5, 7, "Zimna kula", new Modifier(ModifierType.MP_INCREASE, 2)),
    CLOUD_SPHERE(WeaponType.MAGES,       2, 2, 1, 20,       false, 15, 3, 6, "Kula chmur", new Modifier(ModifierType.MP_INCREASE, 2)),
    HOT_SPHERE(WeaponType.MAGES,         2, 2, 1, 20,       false, 15, 3, 6, "Gorąca kula", new Modifier(ModifierType.MP_INCREASE, 2)),
