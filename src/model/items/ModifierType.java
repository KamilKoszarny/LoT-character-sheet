...
public enum ModifierType {
    ...
    LIGHT_MAGIC("<value> do Magii Światła"),
    DARK_MAGIC("<value> do Magii Mroku"),
    ELEMENTAL_MAGIC("<value> do Magii Żywiołów"),
    CHANGE_MAGIC("<value> do Magii Przemian"),
    MAGIC_TALENT("<value> do Talentu Magicznego"),
    ALCHEMY("<value> do Alchemii"),
    MEDICINE("<value> do Medycyny"),
    ENGINEERING("<value> do Inżynierii"),
    TRADING("<value> do Targowania"),
    PERSUASION("<value> do Perswazji"),
